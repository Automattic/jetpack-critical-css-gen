...
### Fixed
- Fix throwing exceptions during ATF selector collection causing the whole generation to fail.
...
[1.0.9-alpha]: https://github.com/Automattic/jetpack-critical-css-gen/compare/v1.0.8...v1.0.9-alpha
